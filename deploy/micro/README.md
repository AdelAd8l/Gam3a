...
- **Close sign-ups** once you've made your accounts: `sudo sed -i 's/_ALLOW_SIGNUP=true/_ALLOW_SIGNUP=false/' /etc/apps/*.env && sudo systemctl restart apps@tally apps@gam3a`.
